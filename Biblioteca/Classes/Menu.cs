            ...
            while(true)
            {
                ...
                switch (opcao)
                {
                    ...
                    case 2:
                        ...
                        break;
                    case 3:
                        Console.Write("Digite o id do livro que quer excluir: ");
                        idProcurado = Convert.ToInt32(Console.ReadLine());
                        Dictionary<int, Livro> livrosAtualizados = controllerLivros.ExcluirLivro(idProcurado);
                        break;
                    case 4:
                        controllerLivros.VerTodosOsLivros();
                        break;
                    case 5:
